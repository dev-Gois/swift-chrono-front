...
import { ChevronsUpDown, Plus, Trophy, Scan } from "lucide-react"
        ...
        <DropdownMenu>
            ...
            >
              {activeTournament ? (
                ...
                <>
                  ...
                  <div className="grid flex-1 text-left text-sm leading-tight">
                    <span className="truncate font-semibold">Selecione Uma Prova</span>
                  </div>
                </>
              )}
          ...
          >
            ...
            <DropdownMenuItem className="gap-2 p-2">
              ...
              <div className="font-medium cursor-pointer" onClick={() => setIsModalOpen(true)}>Criar competição</div>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </SidebarMenuItem>
